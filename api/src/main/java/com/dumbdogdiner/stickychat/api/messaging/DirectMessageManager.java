...
public interface DirectMessageManager {
     ...
     */
    @NotNull DirectMessageResult sendMessage(@NotNull Player from, @NotNull String to, @NotNull String message);
     ...
     * @return A {@link DirectMessageResult} determining the success of the action.
     */
    @NotNull DirectMessageResult sendExternalMessage(@NotNull Player from, @NotNull String to, @NotNull String message);
     ...
     */
    @Nullable String getLast(@NotNull Player player);
     ...
     */
    @NotNull Collection<Player> getDisabledPlayers();
     ...
     */
    @NotNull Boolean hasDirectMessagesDisabled(@NotNull Player player);
