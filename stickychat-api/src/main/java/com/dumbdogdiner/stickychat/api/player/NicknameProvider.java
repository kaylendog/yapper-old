...
public interface NicknameProvider {
     ...
     */
    @NotNull Boolean loadNickname(@NotNull Player player);
     ...
     */
    @NotNull Boolean hasNickname(@NotNull Player player);
     ...
     */
    @NotNull Boolean setNickname(@NotNull Player player, @Nullable String newNickname);
